...
from trl.trainer.online_dpo_trainer import (nn, OnlineDPOConfig, PreTrainedModel, disable_dropout_in_model, Trainer, SIMPLE_CHAT_TEMPLATE, BasePairwiseJudge, SamplingParams, truncate_right, is_wandb_available, DPODataCollatorWithPadding, FeatureExtractionMixin, np, OptimizerNames, os, PeftModel, F, is_peft_available, textwrap, torch, transformers, GenerationConfig, PreTrainedTokenizerBase, Any, ProcessorMixin, datasets, version, warnings, get_comet_experiment_url, empty_cache, apply_chat_template, Callable, prepare_deepspeed, seed_worker, DataCollator, BaseImageProcessor, wraps, PREFIX_CHECKPOINT_DIR, DataLoader, TrainerCallback, generate_model_card, is_conversational, jinja2, create_reference_model, Dataset, EvalPrediction, IterableDataset, Union, get_reward, maybe_apply_chat_template, Optional, unwrap_model_for_generation)
