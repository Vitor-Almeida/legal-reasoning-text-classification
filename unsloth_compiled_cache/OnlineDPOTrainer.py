...
from trl.trainer.online_dpo_trainer import (BaseImageProcessor, empty_cache, np, SamplingParams, Any, generate_model_card, Union, version, jinja2, os, BasePairwiseJudge, transformers, datasets, torch, Dataset, GenerationConfig, get_reward, nn, FeatureExtractionMixin, ProcessorMixin, TrainerCallback, PREFIX_CHECKPOINT_DIR, Callable, seed_worker, disable_dropout_in_model, DPODataCollatorWithPadding, PreTrainedTokenizerBase, OptimizerNames, maybe_apply_chat_template, F, SIMPLE_CHAT_TEMPLATE, create_reference_model, OnlineDPOConfig, is_wandb_available, Optional, unwrap_model_for_generation, EvalPrediction, apply_chat_template, Trainer, is_peft_available, prepare_deepspeed, PreTrainedModel, wraps, PeftModel, IterableDataset, warnings, DataCollator, is_conversational, truncate_right, wandb, textwrap, get_comet_experiment_url, DataLoader)
