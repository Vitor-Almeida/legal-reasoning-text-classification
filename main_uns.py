...
def main():
    ...
    #como fazer eval antes de começar o treino!
    model_name = "modelos/external/unsloth_Qwen2.5-3B-Instruct-unsloth-bnb-4bit"
    output_dir="modelos/local/unsloth_Qwen2.5-3B-Instruct-unsloth-bnb-4bit"
    run_name="unsloth_Qwen2.5-3B-Instruct-unsloth-bnb-4bit-gsm8k"
